...
import InstrCourseDetails from "./InstrCourseDetails";
const Countries = [];
var Curr =""
...
return (
  ...
  <div> {props.courses && props.courses.map((course) =>(
        <InstrCourseDetails course={course} currency={Curr} rate={Rate}/>
    ))}
    </div>
    </div>
)
